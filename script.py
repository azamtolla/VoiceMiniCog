...
spec_md = """# spec.md — MercyCognitive (VoiceMiniCog) Product Specification
...
todo_md = """# todo.md — MercyCognitive Development Tracker
...
with open("output/spec.md", "w") as f:
    f.write(spec_md)

with open("output/todo.md", "w") as f:
    f.write(todo_md)

print("Files written successfully.")
print(f"spec.md: {len(spec_md)} chars")
print(f"todo.md: {len(todo_md)} chars")
